...
function sendRequest() {
	...
	jQuery('#contactWrapper').append('<div class="success"><h4>Email correctamente enviado!</h4><br><p>Gracias por usar nuestro formulario de contacto <strong>'+decodeURIComponent(name)+'</strong>! Your email was successfully sent and we&#39;ll be in touch with you soon.</p></div>');
	}
}
